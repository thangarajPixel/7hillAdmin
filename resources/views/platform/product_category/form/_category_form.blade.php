    ...
    <div class="col-md-8">
        ...
        <div class="fv-row mb-7">
            ...
            <div class="fv-row" >
                ...
                <select name="industrial_category" id="industrial_category" aria-label="Select a Industrial" data-control="select2" data-placeholder="Select a Language..." class="form-select mb-2">
