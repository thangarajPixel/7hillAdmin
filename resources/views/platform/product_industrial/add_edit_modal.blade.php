...
<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_industrial_form" class="form" enctype="multipart/form-data">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7 py-4" id="kt_modal_add_user_scroll"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="kt_ecommerce_add_category_general" role="tab-panel">
                                            @include('platform.product_industrial.form._industrial_form')
                                        </div>
...
<script>
    ...
    var add_url = "{{ route('industrial-module.save') }}";
    // Class definition
    var KTIndustrial = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_industrial_form');
            ...
            submitButton.addEventListener('click', function (e) {
                ...
                if (validator) {
                    validator.validate().then(function(status) {
                        ...
                        if (status == 'Valid') {
                            var from = $('#from').val();
                            var form = $('#add_industrial_form')[0]; 
