...
<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
    ...
    <div class="px-7 py-5" data-kt-industrial-table-filter="form">
        <form id="search-form">
            <div class="mb-10">
                <label class="form-label fs-6 fw-bold">Status:</label>
                <select name="filter_status" id="filter_status" class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                    data-placeholder="Select option" data-allow-clear="true" data-kt-industrial-table-filter="order"
            ...
            <div class="d-flex justify-content-end">
                <button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6"
                    data-kt-menu-dismiss="true" data-kt-industrial-table-filter="reset">Reset</button>
                <button type="submit" class="btn btn-primary fw-bold px-6" data-kt-menu-dismiss="true"
                    data-kt-industrial-table-filter="filter">Apply</button>
            </div>
        </form>
    </div>
</div>
