        ...
        <div class="card">
            <div class="card-header border-0 pt-6 w-100">
                <div class="card-toolbar w-100">
                    <div class="d-flex justify-content-end w-100" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" onclick="return openForm('users')">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
            ...
            <div class="card-body py-4">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-2 mb-0 dataTable no-footer" id="user-table">
                        <thead>
...
@section('add_on_script')
    ...
    <script>
        var dtTable = $('#user-table').DataTable({
