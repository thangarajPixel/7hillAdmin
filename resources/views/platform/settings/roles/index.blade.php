        ...
        <div class="card-header border-0 pt-6 w-100">
            <div class="card-toolbar w-100">
                <div class="d-flex justify-content-end w-100" data-kt-user-table-toolbar="base">
                    @if( access()->hasAccess('roles', 'filter') )
                    <button type="button" id="btn-light-primary" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            <form id="search-form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select name="filter_status" id="filter_status"  class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
