                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Dealer Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                            ...
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Enquiry Name</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['enquiry_name'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>State</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['state'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
