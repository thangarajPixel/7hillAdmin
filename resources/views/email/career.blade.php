                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Career Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                            ...
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Cover Letter</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['cover_letter'] !!}</td>
                                                                                        </tr>
