                            ...
                            <tr>
                                <td valign="middle" style="border-collapse: collapse;">
                                    ...
                                    <table width="800" align="center" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="middle" bgcolor="#f7f7f7" style="border-collapse: collapse;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Product Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                            ...
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Product Name</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['product'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Company Name</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['company_name'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>City</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['city'] !!}</td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
